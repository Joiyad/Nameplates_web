  ...
  return (
    <div>
      <div className="flex flex-wrap gap-2 md:gap-4 justify-center items-center py-20 md:py-40">
        {switchyardData.map(({ id, title, description, imageUrl, data }) => (
          <div onClick={() => handleClick(title, imageUrl, data)} key={id} className="w-[100%] md:w-[40%] flex flex-col justify-center items-center p-4 md:p-6 gap-2 md:gap-4 shadow-lg hover:shadow-2xl rounded-lg cursor-pointer">
